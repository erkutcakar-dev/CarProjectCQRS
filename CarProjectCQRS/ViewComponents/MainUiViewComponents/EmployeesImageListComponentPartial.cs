...
{
    public class EmployeesImageListComponentPartial :ViewComponent
    {
       private readonly GetEmployeeQueryHandler _getEmployeeQueryHandler;

        public EmployeesImageListComponentPartial(GetEmployeeQueryHandler getEmployeeQueryHandler)
        {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var activeValues = values.Where(e => e.IsActive).Take(10).ToList();
